...
contract PaCoin {
    ...
    function PaCoin(uint256 initialSupply, string tokenName, string tokenSymbol, uint8 decimalUnits) public {
...
contract PTokenSales is admined, PaCoin{
    ...
    function PTokenSales(uint256 initialSupply, string tokenName, string tokenSymbol, uint8 decimalUnits, address centralAdmin) PaCoin (0, tokenName, tokenSymbol, decimalUnits ) public {
    ...
    function proofOfWork(uint nonce) public {
        ...
        uint timeSinceLastBlock = (block.timestamp - timeOfLastProof);
